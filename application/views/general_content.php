		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item">
					<img class="d-block w-100" src="<?= base_url('images/img/carousel-1.png')?>" alt="Second slide">
				</div>
				<div class="carousel-item">
					<img class="d-block w-100" src="<?= base_url('images/img/carousel-1.png')?>" alt="Third slide">
				</div>
			</div>
				...
				<div id="carouselExampleFade" class="carousel slide" data-ride="carousel" data-interval="5000">
					<div class="carousel-inner">
						<div class="carousel-item active">
							...
							<div class="row">
								<div class="col-sm-12 col-md-5">
									<img src="<?= base_url('images/img/mt42.png')?>" class="img-fluid" style="max-height: 400px; width: auto;">
								</div>
								<div class="col-sm-12 col-md-7">
									<p>
										Bạn muốn học tiếng Anh nhưng lại không biết bắt đầu từ đâu hay gặp khó khăn trong việc phân bổ thời gian và địa điểm học?
										Hãy đến với chúng tôi, gói Machine Learning sẽ là một giải pháp tuyệt vời cho các vướng mắc của bạn. Chỉ với 3.000đ/ngày
										cùng với hệ thống tài liệu nghe/nói phong phú được update liên tục, bạn sẽ được:
									</p>
									<ul class="cc-li-custom">
										<li><p><span><i class="far fa-check-circle text-color-custom"></i></span><strong> Thực hiện bài test kiểm tra đầu vào thông qua các câu hỏi theo từng cấp độ.</strong></p></li>
										<li><p><span><i class="far fa-check-circle text-color-custom"></i></span><strong> Học Tiếng Anh thông qua các bài học được thiết kế dưới dạng âm thanh với nhiều cấp độ khác nhau.</strong></p></li>
										<li><p><span><i class="far fa-check-circle text-color-custom"></i></span><strong> Kiểm tra trình độ Tiếng Anh của cá nhân thông qua bài kiểm tra nói qua hệ thống.</strong></p></li>
										<li><p><span><i class="far fa-check-circle text-color-custom"></i></span><strong> Lựa chọn lộ trình học phù hợp.</strong></p></li>
										<li><p><span><i class="far fa-check-circle text-color-custom"></i></span><strong> Luyện phát âm ngay trên điện thoại.</strong></p></li>
										<li><p><span><i class="far fa-check-circle text-color-custom"></i></span><strong> Tương tác với hệ thống hoàn toàn bằng giọng nói.</strong></p></li>
										<li><p><span><i class="far fa-check-circle text-color-custom"></i></span><strong> Tham gia kiểm tra chấm điểm hàng tuần.</strong></p></li>
										<li><p><span><i class="far fa-check-circle text-color-custom"></i></span><strong> Sử dụng miễn phí toàn bộ nội dung và tính năng trên SMS, WAP, WEB, APP.</strong></p></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="carousel-item">
							...
							<div class="row">
								<div class="col-sm-12 col-md-7">
									<img src="<?= base_url('images/img/mt43.png')?>" class="img-fluid" style="max-height: 400px; width: auto;">
								</div>
								<div class="col-sm-12 col-md-5">
									<p>
			...
			<div class="tab-content" id="pills-tabContent">
				...
				<div class="tab-pane fade" id="pills-wap" role="tabpanel" aria-labelledby="pills-wap-tab">
					<div class="w-75" style="margin: auto">
						...
						<p class="text-center"><strong>Trường hợp sử dụng kết nối 3G/4G MobiFone hoặc Viettel</strong></p>
								...
								<div class="card text-justify" style="height: 100%; background-color:#f2f5f9;">
									<ul class="list-group list-group-flush">
										<li class="list-group-item">
											...
											<p>Khách hàng chọn gói cước cần đăng kí bao gồm những gói cước sau: Gói cước <span class="text-color-custom">Machine Learning</span>, gói cước <span class="text-color-custom">Promotion</span>, gói cước <span class="text-color-custom">Mẹ Kể Con Nghe</span>, gói cước <span class="text-color-custom">Medium</span>.</p>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="card text-justify align-self-stretch h-100" style="background-color:#f2f5f9;">
									<ul class="list-group list-group-flush">
										<li class="list-group-item">
											...
											<p>Hệ thống sẽ gửi tin nhắn tới thuê bao khách hàng để xác nhận đăng ký qua SMS.
											</p>
										</li>
									</ul>
								</div>
				...
				<div class="tab-pane fade" id="pills-ivr" role="tabpanel" aria-labelledby="pills-ivr-tab">
					<div class="w-50" style="margin: auto;">
						<p class="text-center">Khách hàng gọi đến tổng đài 1048, đăng ký gói cước bằng cách chọn phím bấm tương ứng với gói sau đây:</p>
				...
				<div class="container" style="margin: auto">
					...
					<div class="row" style="padding: 20px 0px 40px 0px">
						<div class="col-sm-12 col-md-3 margin-goi">
							<div class="card text-center text-white h-100" style="background-color:#2798f8; border-radius: 10px;">
								<h4 style="margin-top: 30px;">Machine Learning</h4>
								<h1>3.000đ</h1>
								<div class="w-75" style="margin: auto">
									<p>Mỗi ngày</p>
									<hr style="margin: auto; width: 30px; border: 3px solid white; border-radius: 3px">
									<p><span style="font-weight: bold">Miễn phí cước thuê bao 01 ngày</span> sử dụng đầu tiên cho thuê bao đăng ký lần đầu</p>
									<hr style="margin: auto; width: 80%; border: 1px solid white">
									<p><span style="font-weight: bold">Miễn phí 30 phút gọi</span> lên tổng đài miễn phí mỗi ngày</p>
									<hr style="margin: auto; width: 80%; border: 1px solid white">
						...
						<div class="col-sm-12 col-md-3 margin-goi">
							<div class="card text-center text-white h-100" style="background-color: #257dda; border-radius: 10px;">
								...
								<div class="w-75" style="margin: auto">
									...
									<p><span style="font-weight: bold">Miễn phí cước thuê bao 01 ngày</span> sử dụng đầu tiên cho thuê bao đăng ký lần đầu</p>
									<hr style="margin: auto; width: 80%; border: 1px solid white">
									<p><span style="font-weight: bold">Miễn phí 15 phút gọi</span> lên tổng đài miễn phí mỗi ngày</p>
									<hr style="margin: auto; width: 80%; border: 1px solid white">
									<p style="padding-bottom: 20px;">Không cộng dồn hay bù số phút thừa (chưa sử dụng hết phút miễn phí) sang chu kỳ cước sau</p>
								</div>
							</div>
