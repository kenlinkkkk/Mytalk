...
<!--                    <img class="d-block w-100" src="--><?//= base_url('images/img/banner-7.png') ?><!--" alt="First slide">-->
<!--                </div>-->
<!--				<div class="carousel-item active">-->
...
<!--				</div>-->
				<div class="carousel-item active">
					...
					<div class="col-sm-12 col-md-4 banner-info">
						...
						<h4 class="text-color-custom p-2 font-weight-normal">
							MyTalk là dịch vụ ứng dụng tính năng tương tác bằng giọng nói thông qua đàm thoại để hiểu thông điệp từ người sử dụng khi tương tác bằng giọng nói với dịch vụ
						</h4>
	...
	<div class="w-100">
		<div class="container">
			...
			<div class="row">
				<div id="carouselExampleFade" class="carousel slide" data-ride="carousel" data-interval="5000">
					<div class="carousel-inner">
						<div class="carousel-item active">
							<div class="col-12">
								<h1 class="text-color-custom" style="margin: 20px auto">MACHINE LEARNING</h1>
								<hr style="border: 3px solid #2692f5; border-radius: 3px; width: 30px;">
							</div>
							<div class="row">
								<div class="col-sm-12 col-md-5">
								...
								<div class="col-sm-12 col-md-7">
									<p>
										Bạn muốn học tiếng Anh nhưng lại không biết bắt đầu từ đâu hay gặp khó khăn
										trong việc phân bổ thời gian và địa điểm học?
										Hãy đến với chúng tôi, gói Machine Learning sẽ là một giải pháp tuyệt vời cho
										các vướng mắc của bạn. Chỉ với 3.000đ/ngày
										cùng với hệ thống tài liệu nghe/nói phong phú được update liên tục, bạn sẽ được:
									</p>
									<ul class="cc-li-custom">
										<li><p>
												<span><i
														class="far fa-check-circle text-color-custom"></i></span><strong>
													Thực hiện bài test kiểm tra đầu vào thông qua các câu hỏi theo từng
													cấp độ.</strong></p></li>
										<li><p>
												<span><i
														class="far fa-check-circle text-color-custom"></i></span><strong>
													Học Tiếng Anh thông qua các bài học được thiết kế dưới dạng âm thanh
													với nhiều cấp độ khác nhau.</strong></p></li>
										<li><p>
												<span><i
														class="far fa-check-circle text-color-custom"></i></span><strong>
													Kiểm tra trình độ Tiếng Anh của cá nhân thông qua bài kiểm tra nói
													qua hệ thống.</strong></p></li>
										<li><p>
												<span><i
														class="far fa-check-circle text-color-custom"></i></span><strong>
													Lựa chọn lộ trình học phù hợp.</strong></p></li>
										<li><p>
												<span><i
														class="far fa-check-circle text-color-custom"></i></span><strong>
													Luyện phát âm ngay trên điện thoại.</strong></p></li>
										<li><p>
												<span><i
														class="far fa-check-circle text-color-custom"></i></span><strong>
													Tương tác với hệ thống hoàn toàn bằng giọng nói.</strong></p></li>
										<li><p>
												<span><i
														class="far fa-check-circle text-color-custom"></i></span><strong>
													Tham gia kiểm tra chấm điểm hàng tuần.</strong></p></li>
										<li><p>
												<span><i
														class="far fa-check-circle text-color-custom"></i></span><strong>
													Sử dụng miễn phí toàn bộ nội dung và tính năng trên SMS, WAP, WEB,
													APP.</strong></p></li>
									</ul>
								</div>
							</div>
	...
	<div class="w-100" style="background-color:#f2f5f9;">
		<h1 class="text-center text-color-custom" style="padding: 30px 0px 25px 0">PROMOTION</h1>
		<hr style="margin: auto; border: 3px solid #2692f5; border-radius: 3px; width: 30px;">
		<div class="w-50" style="margin: 20px auto">
			<p class="text-center">Với gói Promotion, bạn sẽ được tham gia tương tác với hệ thống bằng việc trả lời câu
				hỏi theo chủ đề để kiểm tra
				và nâng cao kiến thức về văn hóa, xã hội, giáo dục, giải trí, nghệ thuật,... và nhận giải thưởng tùy
				thời điểm
				diễn ra CTKM.</p>
		</div>
	...
	<!--			<center><a class="btn btn-light" href="-->
	<? //= base_url('khuyen-mai')?><!--">Xem chi tiết</a></center>-->
	<!--		</div>-->
	<!--	</div>-->
	<!-- end khuyen mai -->
	<div class="w-100" id="huongdan">
			...
			<ul class="nav nav-pills mb-3 nav-justified" id="pills-tab" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="pills-sms-tab" data-toggle="pill" href="#pills-sms" role="tab"
					   aria-controls="pills-home" aria-selected="true"><span><img
			...
			<div class="tab-content" id="pills-tabContent">
				<div class="tab-pane fade show active" id="pills-sms" role="tabpanel" aria-labelledby="pills-sms-tab">
					<div class="w-100" style="margin: auto">
						<h4 class="text-center">Soạn tin theo <span class="span-text">&#60CÚ PHÁP&#62</span> gửi <span
								...
								<div class="card text-center" style="background-color:#f2f5f9;">
									<ul class="list-group list-group-flush">
										...
										<li class="list-group-item">
											...
											<div class="row">
												<div class="col-12">
													<p><strong>Soạn DK M hoặc DK</strong></p>
												</div>
											</div>
										</li>
										<li class="list-group-item">
				...
				<div class="tab-pane fade" id="pills-wap" role="tabpanel" aria-labelledby="pills-wap-tab">
					<div class="w-75" style="margin: auto">
						...
						<div class="row" style="margin: 30px 0 30px 0;">
							<div class="col-sm-12 col-md-4">
								<div class="card text-justify" style="height: 100%; background-color:#f2f5f9;">
									<ul class="list-group list-group-flush">
										...
										<li class="list-group-item">
											<p>Khách hàng bấm Menu, sau đó bấm <span
													class="text-color-custom">đăng ký</span>.</p>
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-4">
								<div class="card text-justify" style="height: 100%; background-color:#f2f5f9;">
									<ul class="list-group list-group-flush">
										...
										<li class="list-group-item">
											<p>Khách hàng chọn gói cước cần đăng kí bao gồm những gói cước sau: Gói cước
												<span class="text-color-custom">Machine Learning</span>, gói cước <span
													class="text-color-custom">Promotion</span>, gói cước <span
													class="text-color-custom">Mẹ Kể Con Nghe</span>, gói cước <span
													class="text-color-custom">Medium</span>.</p>
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="col-sm-12 col-md-4">
								<div class="card text-justify align-self-stretch h-100"
									...
									<ul class="list-group list-group-flush">
										...
										<li class="list-group-item">
											<p>Hệ thống sẽ gửi tin nhắn tới thuê bao khách hàng để xác nhận đăng ký qua
												SMS.
											</p>
										</li>
									</ul>
						...
						<p class="text-center"><strong>Trường hợp sử dụng kết nối WiFi hoặc hệ thống không nhận diện
								được số thuê bao:</strong></p>
						...
						<p class="text-center">Hệ thống không hỗ trợ hủy dịch vụ trên website. Để hủy dịch vụ, khách
							hàng soạn cú pháp tin nhắn theo hướng dẫn.</p>
					</div>
				</div>

				<div class="tab-pane fade" id="pills-ivr" role="tabpanel" aria-labelledby="pills-ivr-tab">
					<div class="w-50" style="margin: auto;">
						<p class="text-center">Khách hàng gọi đến tổng đài 1048, đăng ký gói cước bằng cách chọn phím
							bấm tương ứng với gói sau đây:</p>
						<h4 class="text-center text-color-custom">Với thuê bao MobiFone</h4>
						<div class="row">
							<div class="col-sm-12 col-md-6">
								<div class="card text-center" style="margin: 30px 0 30px 0;">
									<ul class="list-group list-group-flush">
										<li class="list-group-item">
											<p class="text-color-custom"><strong>Gói Machine Learning</strong></p>
							...
							<div class="col-sm-12 col-md-6">
								<div class="card text-center" style="margin: 30px 0 30px 0;">
									<ul class="list-group list-group-flush">
										<li class="list-group-item">
											<p class="text-color-custom"><strong>Gói Promotion</strong></p>
			...
			<div class="w-100" id="goidichvu">
				...
				<div class="container" style="margin: auto">
					<div class="row">
						...
						<div class="col-6">
							<h4 class="text-color-custom" style="font-weight: bolder">40 đồng/phút <span>(Tính theo block 1+1 phút)</span>
							</h4>
							<h4 class="text-color-custom" style="font-weight: bolder">Miễn phí <span>(Đăng ký/hủy và các cú pháp tiện ích khác)</span>
							</h4>
						</div>
					</div>
						...
						<div class="col-sm-12 col-md-3 margin-goi">
							<div class="card text-center text-white h-100"
								...
								<div class="w-75" style="margin: auto">
									...
									<p><span style="font-weight: bold">Miễn phí 30 phút gọi</span> lên tổng đài miễn phí
										mỗi ngày</p>
									<hr style="margin: auto; width: 80%; border: 1px solid white">
									<p style="padding-bottom: 20px;">Không cộng dồn hay bù số phút thừa (chưa sử dụng
										hết phút miễn phí) sang chu kỳ cước sau</p>
								</div>
							</div>
						</div>
							...
							<div class="card text-center text-white h-100"
								...
								<div class="w-75" style="margin: auto">
									...
									<p><span style="font-weight: bold">Miễn phí cước thuê bao 01 ngày</span> sử dụng đầu
										tiên cho thuê bao đăng ký lần đầu</p>
									<hr style="margin: auto; width: 80%; border: 1px solid white">
									<p><span style="font-weight: bold">Miễn phí 15 phút gọi</span> lên tổng đài miễn phí
										mỗi ngày</p>
									<hr style="margin: auto; width: 80%; border: 1px solid white">
									<p style="padding-bottom: 20px;">Không cộng dồn hay bù số phút thừa (chưa sử dụng
										hết phút miễn phí) sang chu kỳ cước sau</p>
		...
		<div class="w-100" id="aboutme" style="background-color:#f2f5f9;">
			...
			<div class="container">
				<p class="text-center">
					Công ty cổ phần VANO được thành lập 12/02/2009 theo Giấy chứng nhận đăng lý kinh doanh số 0103327293
					do Sở Kế hoạch & Đầu tư Tp.Hà Nội cấp năm 2009
					với chức năng, ngành nghề chính là kinh doanh dịch vụ viễn thông, công nghệ thông tin và nội dung số
					nói chung. Từ khi thành lập, với đội ngũ nhân sự
					đông đảo, giàu năng lực và nhiệt huyết, VANO tự hào là dội ngũ tiên phong trong lĩnh vực nội dung
					số. Các dịch vụ do chúng tôi cung cấp luôn tạo ra các
					giá trị thiết thực, thu hút đông đảo khách hàng tham gia.
				</p>

				<p style="font-weight: bold" class="text-center text-color-custom">Ngoài Mytalk 4.0, hãy cùng điểm qua
					một số dịch vụ nổi bật khác mà VANO cung cấp nhé:</p>
			</div>
			<div class="w-100"
				 style="background-image: linear-gradient(to bottom, #67e0f5, #007bff);padding: 40px 0px 40px 0px; margin-top: 40px">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 col-md-4 margin-top-app">
							<div class="card text-center text-white"
								...
								<div>
									<img src="<?= base_url('images/icon/love.png') ?>" class="img-fluid"
										 style="position: absolute; margin: -80px auto auto -40px">
								</div>
								<h4>Dịch vụ kết bạn Hulaa</h4>
								<p class="text-justify">
									Kết bạn Hulaa là một mô hình dịch vụ kết bạn mới lạ, hấp dẫn trên mạng MobiFone, kết
									hợp các tính năng tương tác và bộ lọc tiêu chí
									đối tượng đa dạng của các mô hình Kết bạn hiện nay với các nền tảng dịch vụ viễn
									thông, tạo ra sự trải nghiệm và thú vị cho các khách
						...
						<div class="col-sm-12 col-md-4 margin-top-app">
							<div class="card text-center text-white"
								 style="background-color: transparent; border: none;">
								<div>
									<img src="<?= base_url('images/icon/bank.png') ?>" class="img-fluid"
										 style="position: absolute; margin: -80px auto auto -40px">
								</div>
								<h4>Đấu giá linh hoạt - iBid</h4>
								<p class="text-justify">
									Đấu giá linh hoạt - iBid là hệ thống các chương trình đấu giá trực tuyến dành cho
									các thuê bao MobiFone với nhiều hình thức linh hoạt:
									đặt giá cao nhất và duy nhất, đặt giá thấp nhất và duy nhất, đặt giá sớm nhất và duy
									nhất,... được thay đổi luân phiên theo từng loại
									hình sản phẩm và phiên đấu giá sẽ tạo nên sự hấp dẫn và cuốn hút đối với Khách hàng
									MobiFone. Khi tham gia đấu giá iBid, người chơi tham
									gia sẽ có cơ hội trúng những sản phẩm hấp dẫn như thẻ cào, usb, ổ cứng di động, loa
									nghe nhạc, smartphone,…
								</p>
							</div>
						</div>
						...
						<div class="col-sm-12 col-md-4 margin-top-app">
							<div class="card text-center text-white"
								 style="background-color: transparent; border: none;">
								<div>
									<img src="<?= base_url('images/icon/mask.png') ?>" class="img-fluid"
										 style="position: absolute; margin: -80px auto auto -40px">
								</div>
								<h4>Dịch vụ Kho giải trí</h4>
								<p class="text-justify">
									Dịch vụ Kho giải trí cung cấp thông tin về những chương trình giải trí hấp dẫn được
									chiếu trên truyền hình thông qua SMS và Wapsite. Sau khi
									đăng ký tham gia, khách hàng có thể truy cập wapsite để xem các video, audio, tin
									tức mới nhất về các chương trình truyền hình như gameshow,
									truyền hình thực tế, tin tức thời sự, thông tin văn hóa du lịch, tham gia nhắn tin
									bình chọn thần tượng để có cơ hội nhận các giải thưởng hấp dẫn.
								</p>
							</div>
						</div>
					</div>
