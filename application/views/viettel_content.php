			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					...
					<div class="col-sm-12 col-md-4 banner-info">
						<h2 class="text-color-custom p-2 font-weight-bolder">Dịch vụ ứng dụng tính năng công nghệ mới</h2>
						<h4 class="text-color-custom p-2 font-weight-normal">
							MyTalk 4.0 là dịch vụ duy nhất của MobiFone ứng dụng tính năng công nghệ “speech to text” -  nhận diện giọng nói, làm việc trên nền tảng trí tuệ nhân tạo AI
						</h4>
				...
				<div class="carousel-item">
					...
					<div class="col-sm-12 col-md-4 banner-info">
						<h2 class="text-color-custom p-2 font-weight-bolder">Học Tiếng Anh một cách tiện lợi và thông minh hơn</h2>
						<h4 class="text-color-custom p-2 font-weight-normal">
				...
				<div class="carousel-item">
					...
					<div class="col-sm-12 col-md-4 banner-info">
						<h2 class="text-color-custom p-2 font-weight-bolder">Thử thách và nâng cao kiến thức của bản thân với bộ câu hỏi đa lĩnh vực</h2>
						<h4 class="text-color-custom p-2 font-weight-normal">
							Thỏa sức thử thách bản thân với các câu hỏi thú vị, hấp dẫn trên mọi lĩnh vực cùng cơ hội nhận các phần thưởng vô cùng hấp dẫn
						</h4>
						<a class="btn btn-outline-success"  href="#goidichvu">Đăng ký</a>
					</div>
				</div>
				<div class="carousel-item">
					...
					<div class="col-sm-12 col-md-4 banner-info">
						<h2 class="text-color-custom p-2 font-weight-bolder">Chương trình khuyến mại với các phần thưởng cực kỳ hấp dẫn</h2>
						<h4 class="text-color-custom p-2 font-weight-normal">
							Các CTKM diễn ra theo từng thời kỳ với những phần thưởng hấp dẫn sẽ đem đến cho bạn những trải nghiệm tuyệt vời
						</h4>
						<a class="btn btn-outline-success"  href="#goidichvu">Đăng ký</a>
					</div>
				</div>
				<div class="carousel-item">
					...
					<div class="col-sm-12 col-md-4 banner-info">
						...
						<h4 class="text-color-custom p-2 font-weight-normal">
							Thoải mái trải nghiệm và khám phá dịch vụ với giá cước chỉ 3.000đ/ngày, miễn phí ngày đầu đăng ký
						</h4>
						<a class="btn btn-outline-success"  href="#goidichvu">Đăng ký</a>
					</div>
				</div>
