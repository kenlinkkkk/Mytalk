			...
			<div class="tab-content" id="pills-tabContent">
				...
				<div class="tab-pane fade" id="pills-wap" role="tabpanel" aria-labelledby="pills-wap-tab">
					<div class="w-75" style="margin: auto">
						...
						<p class="text-center"><strong>Trường hợp sử dụng kết nối 3G/4G MobiFone</strong></p>
							...
							<div class="col-sm-12 col-md-4">
								<div class="card text-justify" style="height: 100%; background-color:#f2f5f9;">
									<ul class="list-group list-group-flush">
										...
										<li class="list-group-item">
											<p>Khách hàng chọn gói cước cần đăng kí bao gồm những gói cước sau: Gói cước <span class="text-color-custom">Machine Learning</span>, gói cước <span class="text-color-custom">Promotion</span>.</p>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="w-75" style="margin: auto">
						<div class="row" style="padding: 20px 0px 40px 0px">
							<div class="col-sm-12 col-md-6 margin-goi">
								<div class="card text-center text-white" style="background-color:#2798f8; border-radius: 10px;">
							...
							<div class="col-sm-12 col-md-6 margin-goi">
								<div class="card text-center text-white" style="background-color: #257dda; border-radius: 10px;">
